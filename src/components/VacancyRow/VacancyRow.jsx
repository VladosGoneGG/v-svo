...
const vacancyItemCls =
	'flex items-center justify-between bg-[#EDEDED] rounded-[12px] p-4'
const vacancyTitleCls = 'font-golos font-semibold text-[18px]'
const vacancyTagsRowCls =
	'font-golos font-medium text-[14px] flex flex-wrap gap-3 leading-none'
const vacancyTagsWrapCls =
	'font-golos font-medium text-[14px] flex flex-wrap gap-x-3 gap-y-1 leading-none'
...
const VacancyRow = ({ title, tags }) => {
	...
	return (
		<div className={vacancyItemCls}>
			...
			<div className='shrink-0 w-10 h-10 rounded-full bg-[#6f737c] flex items-center justify-center'>
